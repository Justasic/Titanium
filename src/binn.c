...
/***************************************************************************/
extern int type_family(int type);
...
unsigned char * SearchForKey(unsigned char *p, int header_size, int size, int numitems, char *key) {
...
BOOL binn_object_set_raw(binn *item, char *key, int type, void *pvalue, int size) {
  unsigned char *p, len;
  int int32;
